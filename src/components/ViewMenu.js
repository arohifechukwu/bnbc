...
const menuData = [
    { id: 1, caption: 'Expresso', description: 'Strong, rich coffee brewed by forcing hot water through finely-ground beans.', price: '$10', image: `${process.env.PUBLIC_URL}/images/expresso.jpeg` },
